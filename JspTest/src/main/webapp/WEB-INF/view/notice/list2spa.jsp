	...
	<nav class="menu">
		...
		<main class="main">
			...
			<div class="notice margin-top">
				...
				<% while(rs.next()){ %>
					<tr>
						<td><%=rs.getInt("ID")%></td>                  <!--  //태그 누르면 detail페이지로넘어감 -->
						<td class="title indent text-align-left"><a href="detail2spa.jsp?id=<%=rs.getInt("ID")%>"><% rs.getString("TITLE") %></a></td>
						<td><%rs.getString("WRITER_ID") %></td>
						<td>
							<%rs.getDate("REGDATE") %>		
						</td>
						<td><%get.Integer("HIT") %></td>
					</tr>
